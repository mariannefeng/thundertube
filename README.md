...
The AI tab uses gemini 2.5 flash lite. GEMINI_API_KEY is configured with a .env.local.sh file at the root of the project directory.
...
Code can be saved either to mongo or a local file. This can be configured with a server/databaseconfig.js file.
